...
def RegistrarCliente():
    ...
    TelaRegistroCliente.lineEdit.setText("")
    TelaRegistroCliente.lineEdit_2.setText("")
    TelaRegistroCliente.lineEdit_3.setText("")
...
def LogarCliente():
    ...
    TelaLoginCliente.lineEdit.setText("")
    TelaLoginCliente.lineEdit_3.setText("")
...
def ListarDescricao():
    ...
    l = SELECT(["nome","descrição","duracao_hora","duracao_minuto"],"filme",True,"nome",nome)
...
def ListarSelecionarSessao():
    ...
    ID = int(x[0][0])
    filme = SELECT(["id","nome","descrição","cpf_funcionario"],"filme",True,"id",str(ID))
...
def MeusBilhetesInfoBilhete():
    ...
    TelaDescricaoBilhete.label.setText("" + nome)
    TelaDescricaoBilhete.label_2.setText("Id da sessão: " + str(ID_SESSAO))
    TelaDescricaoBilhete.label_3.setText("Id do bilhete: " + str(ID_BILHETE))
    TelaDescricaoBilhete.label_4.setText("" + dia + "/" + mes + "/" + ano)
    TelaDescricaoBilhete.label_5.setText("" + sala)
    TelaDescricaoBilhete.label_6.setText("" + hora + ":" + minuto)
    TelaDescricaoBilhete.label_8.setText("" + dia + "/" + mes + "/" + ano)
    TelaDescricaoBilhete.label_9.setText("" + hora + ":" + minuto)
